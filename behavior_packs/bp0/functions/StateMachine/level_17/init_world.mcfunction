...
scoreboard  players set sugar_rush level_index 17
scoreboard  players set sugar_rush chapter_id 2
scoreboard  players set sugar_rush level_id 7
...
scoreboard  players set sugar_rush wave_attackers 16
scoreboard  players set sugar_rush surge_attackers 9
scoreboard  players set sugar_rush wave_s_intvl 81
