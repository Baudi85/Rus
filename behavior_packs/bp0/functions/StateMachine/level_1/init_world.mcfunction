...
scoreboard  players set sugar_rush wave_attackers 5
scoreboard  players set sugar_rush surge_attackers 3
scoreboard  players set sugar_rush wave_s_intvl 240
scoreboard  players set sugar_rush surge_s_intvl 33
