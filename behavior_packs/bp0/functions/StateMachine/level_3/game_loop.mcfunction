...
execute  if score sugar_rush sequence_count >= sugar_rush sequences if score sugar_rush level_timer >= sugar_rush total_level_time if score sugar_rush attackers_alive matches 0 positioned 33 16 113 run function StateMachine/TD/win_seq_no_sc