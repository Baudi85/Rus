...
scoreboard  players set sugar_rush level_index 28
...
scoreboard  players set sugar_rush single_seq_time 1060
scoreboard  players set sugar_rush wave_lead 0
scoreboard  players set sugar_rush wave_seq_time 960
scoreboard  players set sugar_rush surge_seq_time 100
scoreboard  players set sugar_rush wave_time 860
...
scoreboard  players set sugar_rush wave_s_intvl 40
