...
scoreboard  players set sugar_rush level_index 6
scoreboard  players set sugar_rush chapter_id 1
scoreboard  players set sugar_rush level_id 6
...
scoreboard  players set sugar_rush total_level_time 5000
scoreboard  players set sugar_rush total_seq_time 4760
scoreboard  players set sugar_rush single_seq_time 2380
scoreboard  players set sugar_rush wave_lead 0
scoreboard  players set sugar_rush wave_seq_time 2280
scoreboard  players set sugar_rush surge_seq_time 100
scoreboard  players set sugar_rush wave_time 2180
scoreboard  players set sugar_rush sequences 2
scoreboard  players set sugar_rush wave_attackers 10
scoreboard  players set sugar_rush surge_attackers 5
scoreboard  players set sugar_rush wave_s_intvl 198
scoreboard  players set sugar_rush surge_s_intvl 20
