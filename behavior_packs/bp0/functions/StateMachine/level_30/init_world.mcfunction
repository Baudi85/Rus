...
scoreboard  players set sugar_rush level_index 30
...
scoreboard  players set sugar_rush wave_attackers 22
scoreboard  players set sugar_rush surge_attackers 11
scoreboard  players set sugar_rush wave_s_intvl 35
scoreboard  players set sugar_rush surge_s_intvl 9
