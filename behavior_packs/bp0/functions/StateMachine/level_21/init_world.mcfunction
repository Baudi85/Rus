...
scoreboard  players set sugar_rush level_index 21
...
scoreboard  players set sugar_rush total_seq_time 6360
scoreboard  players set sugar_rush single_seq_time 1590
scoreboard  players set sugar_rush wave_lead 0
scoreboard  players set sugar_rush wave_seq_time 1490
scoreboard  players set sugar_rush surge_seq_time 100
scoreboard  players set sugar_rush wave_time 1390
scoreboard  players set sugar_rush sequences 4
scoreboard  players set sugar_rush wave_attackers 12
scoreboard  players set sugar_rush surge_attackers 6
scoreboard  players set sugar_rush wave_s_intvl 106
