...
scoreboard  players set sugar_rush level_index 31
scoreboard  players set sugar_rush chapter_id 4
scoreboard  players set sugar_rush level_id 1
...
function StateMachine/TD/credits
scoreboard  players set sugar_rush preparation_time 19999980
scoreboard  players set sugar_rush total_level_time 19999980
...
scoreboard  players set sugar_rush wave_seq_time -100
scoreboard  players set sugar_rush surge_seq_time 100
scoreboard  players set sugar_rush wave_time -200
scoreboard  players set sugar_rush sequences 1
scoreboard  players set sugar_rush wave_attackers 0
scoreboard  players set sugar_rush surge_attackers 1
scoreboard  players set sugar_rush wave_s_intvl -200
scoreboard  players set sugar_rush surge_s_intvl 100
