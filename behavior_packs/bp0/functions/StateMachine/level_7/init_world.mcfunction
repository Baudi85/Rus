...
scoreboard  players set sugar_rush level_index 7
...
scoreboard  players set sugar_rush total_level_time 5400
scoreboard  players set sugar_rush total_seq_time 5160
scoreboard  players set sugar_rush single_seq_time 2580
scoreboard  players set sugar_rush wave_lead 0
scoreboard  players set sugar_rush wave_seq_time 2480
scoreboard  players set sugar_rush surge_seq_time 100
scoreboard  players set sugar_rush wave_time 2380
...
scoreboard  players set sugar_rush wave_s_intvl 170
