...
scoreboard  players set sugar_rush level_index 19
...
scoreboard  players set sugar_rush wave_attackers 24
scoreboard  players set sugar_rush surge_attackers 13
scoreboard  players set sugar_rush wave_s_intvl 55
scoreboard  players set sugar_rush surge_s_intvl 7
