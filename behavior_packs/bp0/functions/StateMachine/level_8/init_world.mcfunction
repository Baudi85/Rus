...
scoreboard  players set sugar_rush level_index 8
...
scoreboard  players set sugar_rush total_level_time 6000
scoreboard  players set sugar_rush total_seq_time 5760
scoreboard  players set sugar_rush single_seq_time 2880
scoreboard  players set sugar_rush wave_lead 0
scoreboard  players set sugar_rush wave_seq_time 2780
scoreboard  players set sugar_rush surge_seq_time 100
scoreboard  players set sugar_rush wave_time 2680
scoreboard  players set sugar_rush sequences 2
scoreboard  players set sugar_rush wave_attackers 18
scoreboard  players set sugar_rush surge_attackers 9
scoreboard  players set sugar_rush wave_s_intvl 141
scoreboard  players set sugar_rush surge_s_intvl 11
