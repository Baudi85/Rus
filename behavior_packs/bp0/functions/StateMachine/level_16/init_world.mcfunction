...
scoreboard  players set sugar_rush level_index 16
...
scoreboard  players set sugar_rush single_seq_time 2120
scoreboard  players set sugar_rush wave_lead 0
scoreboard  players set sugar_rush wave_seq_time 2020
scoreboard  players set sugar_rush surge_seq_time 100
scoreboard  players set sugar_rush wave_time 1920
scoreboard  players set sugar_rush sequences 3
scoreboard  players set sugar_rush wave_attackers 17
