...
scoreboard  players set sugar_rush level_index 24
...
scoreboard  players set sugar_rush single_seq_time 1272
scoreboard  players set sugar_rush wave_lead 0
scoreboard  players set sugar_rush wave_seq_time 1172
scoreboard  players set sugar_rush surge_seq_time 100
scoreboard  players set sugar_rush wave_time 1072
scoreboard  players set sugar_rush sequences 5
scoreboard  players set sugar_rush wave_attackers 16
scoreboard  players set sugar_rush surge_attackers 8
scoreboard  players set sugar_rush wave_s_intvl 63
scoreboard  players set sugar_rush surge_s_intvl 12
